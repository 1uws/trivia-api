...
Specify the app folder and database user before running the server.
...
- General:
	...
	- Result is paginated to 10 questions each query. By default returs the first page.
...
- General:
	...
	- Deletes a question of the given ID if exists.
...
- General:
	...
	- Searches and returns a list of questions whose question string includes the requested search term.
...
- General:
	...
	- Returns list of questions from a category.
...
- General:
	...
	- Request for the next question in quizz.

	- Summits list of previous questions' id, and category dict with id field.
